  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-neutral-950 text-white">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl mx-auto w-full mt-12 animate-in fade-in zoom-in-95 duration-1000">
        ...
        {/* Brand Name */}
        <div className="mb-8 md:mb-6 w-full">
          <h1 className="text-5xl md:text-8xl font-black tracking-tighter uppercase italic text-transparent bg-clip-text bg-gradient-to-br from-white via-neutral-200 to-neutral-500 drop-shadow-xl leading-[1.1] md:leading-none">
            {/* Using block elements to control the break and give the Y room to render */}
            <span className="block pr-4 md:inline md:pr-0">The Fly</span>
            <span className="block md:inline md:ml-4">& Ride</span>
          </h1>
        </div>
        ...
        {/* Status Indicator */}
        <h2 className="text-2xl md:text-3xl font-light text-neutral-300 mb-6 uppercase tracking-[0.2em] md:tracking-[0.3em]">
          <span className="text-orange-500 font-semibold mr-2 md:mr-3">Status:</span>
          In The Garage
        </h2>
